import {createGesture, CreateAnimation, Gesture, GestureDetail,  IonTitle} from '@ionic/react';
import React from 'react';
import './Title.scss';
const MAX_TRANSLATE = window.innerWidth-200;
                ...
                <div className="track">
                    <CreateAnimation
                        ...
                        fromTo={{
                            ...
                            toValue: `translateX(${window.innerWidth-200}px)`
                        }}>
                        <IonTitle className="title">Cake app</IonTitle>
                    </CreateAnimation>
                </div>
            </>
        );
